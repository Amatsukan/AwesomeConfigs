...
-- {{{ Tags
tags = {
   names = { " WEB ", " TERMINAL ", " FILES ", " OTHER ", " SPOTFY " },
...
globalkeys = awful.util.table.join(
    ...
    -- Copy to clipboard
    awful.key({ "Control", "Shift" }, "c", function () os.execute("xsel -p -o | xsel -i -b") end),
...
awful.rules.rules = {
    ...
    {rule = { class = "gnome-terminal"},
          properties = { tag = tags[1][2], opacity = 0.80 } },
